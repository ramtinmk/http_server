...
/*
 * Run the event loop until *running becomes 0.
 * server_fd must already be bound and listening. The loop makes it and
 * all accepted sockets nonblocking, and registers them with epoll.
